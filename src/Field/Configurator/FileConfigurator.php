...
final readonly class FileConfigurator implements FieldConfiguratorInterface
{
    ...
    public function configure(FieldDto $field, EntityDto $entityDto, AdminContext $context): void
    {
        ...
        $uploadDir = $field->getCustomOption(FileField::OPTION_UPLOAD_DIR);
        if (null === $uploadDir) {
        ...
        $field->setFormTypeOption('risky_inline_render', $field->getCustomOption(FileField::OPTION_RISKY_INLINE_RENDER));
    }
